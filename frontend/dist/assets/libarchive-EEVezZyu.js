 ...
 */
const e = Symbol("Comlink.proxy"), t = Symbol("Comlink.endpoint"), n = Symbol("Comlink.releaseProxy"), r = Symbol("Comlink.finalizer"), i = Symbol("Comlink.thrown"), s = (e2) => "object" == typeof e2 && null !== e2 || "function" == typeof e2, a = /* @__PURE__ */ new Map([["proxy", { canHandle: (t2) => s(t2) && t2[e], serialize(e2) {
...
const h = /* @__PURE__ */ new WeakMap(), f = "FinalizationRegistry" in globalThis && new FinalizationRegistry((e2) => {
...
class O {
  static init(e2 = null) {
    return O._options = e2 || {}, O._options;
  }
  static async open(e2) {
    const t2 = O.getWorker(O._options), n2 = await O.getClient(t2, O._options), r2 = new A(e2, n2, t2);
    return await r2.open();
  }
  static async write({ files: e2, outputFileName: t2, compression: n2, format: r2, passphrase: i2 = null }) {
    const s2 = O.getWorker(O._options), a2 = await O.getClient(s2, O._options), o2 = await a2.writeArchive(e2, n2, r2, i2);
    return s2.terminate(), new File([o2], t2, { type: "application/octet-stream" });
  }
  static getWorker(e2) {
    return e2.getWorker ? e2.getWorker() : new Worker(e2.workerUrl || new URL("/assets/worker-bundle-Dx5mKZOL.js", import.meta.url), { type: "module" });
  }
