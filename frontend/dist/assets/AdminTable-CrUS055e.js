import { bi as defineComponent, be as isRef, a_ as shallowRef, w as watch, g as ref, bj as watchEffect, a$ as h, y as unref, F as computed, j as createElementBlock, k as openBlock, l as createBaseVNode, K as Fragment, L as renderList, n as normalizeClass, p as createCommentVNode, z as createVNode, t as toDisplayString, aU as renderSlot } from "./index-BQxzU9F1.js";
/**
   * table-core
   *
...
const _hoisted_2 = { class: "hidden md:block flex-1 overflow-auto" };
const _hoisted_3 = { class: "min-w-full divide-y divide-gray-200 dark:divide-gray-700 table-fixed" };
const _hoisted_4 = { class: "bg-gray-50 dark:bg-gray-700" };
...
const _hoisted_10 = { class: "bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700" };
const _hoisted_11 = { key: 0 };
const _hoisted_12 = ["colspan"];
const _hoisted_13 = { class: "md:hidden flex-1 overflow-auto" };
const _hoisted_14 = {
  key: 0,
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const getSortHeaderClass = (column) => {
      const baseClass = column.getCanSort() ? "cursor-pointer select-none flex items-center hover:text-gray-700 dark:hover:text-gray-200 transition-colors" : "flex items-center";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("table", _hoisted_3, [
                ...
                return openBlock(), createElementBlock("tr", {
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(headerGroup.headers, (header) => {
                    return openBlock(), createElementBlock("th", {
                      key: header.id,
                      scope: "col",
                      class: normalizeClass(["px-3 py-3 text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider", [props.columnClasses[header.column.id] || "text-left"]])
                    }, [
                      !header.isPlaceholder ? (openBlock(), createElementBlock("div", {
                        key: 0,
                        class: normalizeClass(getSortHeaderClass(header.column)),
                        ...
                        header.column.getCanSort() ? (openBlock(), createElementBlock("span", _hoisted_6, [
                          header.column.getIsSorted() === "asc" ? (openBlock(), createElementBlock("span", _hoisted_7, "↑")) : header.column.getIsSorted() === "desc" ? (openBlock(), createElementBlock("span", _hoisted_8, "↓")) : (openBlock(), createElementBlock("span", _hoisted_9, "↕"))
            ...
            createBaseVNode("tbody", _hoisted_10, [
              props.data.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_11, [
                createBaseVNode("td", {
                  class: "px-3 py-4 text-sm text-gray-500 dark:text-gray-400 text-center",
                  colspan: unref(table).getAllColumns().length
                }, toDisplayString(props.emptyText), 9, _hoisted_12)
              ])) : createCommentVNode("", true),
                ...
                return openBlock(), createElementBlock("tr", {
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(row.getVisibleCells(), (cell) => {
                    return openBlock(), createElementBlock("td", {
                      key: cell.id,
                      class: normalizeClass(["px-3 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100", props.columnClasses[cell.column.id]])
                    }, [
                      createVNode(unref(FlexRender), {
        ...
        createBaseVNode("div", _hoisted_13, [
          props.data.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_14, toDisplayString(props.emptyText), 1)) : createCommentVNode("", true),
          renderSlot(_ctx.$slots, "mobile", {
            data: props.data
          })
        ])
      ]);
